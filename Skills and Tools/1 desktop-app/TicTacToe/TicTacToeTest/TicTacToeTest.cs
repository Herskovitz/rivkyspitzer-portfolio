...
namespace TicTacToeTest
{
    public class Tests
    {
        ...
        public void TestStartGame()
        {
            Game game = new Game();
            game.StartGame();
            string msg = $"Game status = {game.GameStatus.ToString()}. Current turn = {game.CurrentTurn.ToString()}. The number of spots = {game.Spots.Count}";
        ...
        public void TestWinner(int x0, int o0, int x1, int o1, int x2)
        {
            ...
            game.TakeSpot(o1);
            game.TakeSpot(x2);
            string msg = $"Winner is {game.Winner.ToString()}. Game status is {game.GameStatus}";
